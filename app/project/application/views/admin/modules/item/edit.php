	...
	<div class="card card-cascade narrower">
		...
		<div class="view view-cascade py-3 gradient-card-header info-color-dark mx-4 d-flex justify-content-between align-items-center">
			...
			*/ ?>
			...
			<a href="#" class="white-text mx-3">Edit Item</a>
		...
		<div class="card-body card-body-cascade">
			...
			<form class="text-center" style="color: #757575;" action="<?= site_url('admin/item/edit/'.$id) ?>" method="POST">
				...
				<!-- Email -->
				<div class="md-form">
					<input type="text" id="item_name" name="item_name" class="form-control" placeholder="Item Name" value="<?= $row->item_name ?>">
				...
				<!-- Password -->
				<div class="md-form">
					<input type="number" id="item_price" name="item_price" class="form-control" placeholder="Item Price" value="<?= $row->item_price ?>">
