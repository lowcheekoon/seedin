	...
	<div class="col-12">
		...
		<div class="card">
			...
			<h5 class="card-header info-color white-text text-center py-4">
				<strong>Member Panel - Sign in</strong>
			</h5>
			...
			<div class="card-body px-lg-5 pt-0">
				...
				<!-- Form -->
				<form class="text-center" style="color: #757575;" action="<?= site_url('member/login') ?>" method="POST">
					...
					<a href="<?= site_url('member/register') ?>" class="btn btn-primary btn-block my-4 waves-effect waves-light">Register</a>
